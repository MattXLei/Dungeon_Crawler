...
public class Room3Activity extends GameActivity {
    ...
    private InvulnerableDecorator invulnerable;
    ...
    public void createPowerUp(ConstraintLayout gameLayout) {
        ...
        invulnerable = new InvulnerableDecorator(powerup);
        powerUpView = new PowerUpView(this, powerUpLocation, powerup, invulnerable);
