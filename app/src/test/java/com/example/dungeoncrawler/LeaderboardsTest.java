...
public class LeaderboardsTest {
    ...
    public void SortedAttempts() {
        ...
        assertEquals(Leaderboard.getAttempts()[0].getScore(), 10);
        assertEquals(Leaderboard.getAttempts()[1].getScore(), 20);
        assertEquals(Leaderboard.getAttempts()[2].getScore(), 30);
        assertEquals(Leaderboard.getAttempts()[3].getScore(), 40);
        assertEquals(Leaderboard.getAttempts()[4].getScore(), 50);
